import { sortProjectsByPeriodDesc } from '@/lib/utils'
...
const photographyProjects: Project[] = [
  {
    id: 9002,
    title: 'RIDUGE 2026 — 1er Prix',
    description: 'Moments forts du Rallye International des Universités et Grandes Écoles 2026, remporté aux côtés de Imane Halif.',
    fullDescription: 'Couverture photo du RIDUGE 2026 : victoire, solidarité, classement et parcours à travers 9 villes du Maroc. 1er prix du rallye universitaire avec l\'équipage UMI — Faculté des Sciences Meknès.',
    domain: 'photography',
    thumbnail: '/honors/riduge/winner.jpeg',
    images: [
    ...
    logo: { url: '/honors/riduge/logo.png', description: 'RIDUGE' },
    category: 'Photography & Events',
    period: 'Apr 2026',
    technologies: ['Photography', 'Event Coverage'],
    link: '/honors/riduge-2026',
    associated: 'Université Moulay Ismail Meknès — avec Imane Halif',
  },
  {
    id: 9001,
...
const webDevelopmentProjects: Project[] = [
  ...
  },
  {
    ...
    description: 'Plateforme de cours particuliers en ligne (module UML & Génie Logiciel GINF5) connectant élèves et professeurs certifiés, avec cours personnalisés en visioconférence.',
    domain: 'web-development',
  ...
  {
    id: 17,
    title: 'Eco Rénovation',
    description: 'Plateforme digitale complète pour une entreprise de couverture, charpente, zinguerie, isolation et rénovation de toiture dans les Landes et le Pays Basque.',
    domain: 'web-development',
    thumbnail: '/Siteweb/eco-renovation/couverture.jpeg',
    images: [
      '/Siteweb/eco-renovation/couverture.jpeg',
      '/Siteweb/eco-renovation/screenshot-2.jpeg',
    ],
    logo: {
      url: '/Siteweb/eco-renovation/logo.svg',
      description: 'Eco Rénovation',
    },
    category: 'Web Development & Roofing / BTP',
    period: 'Juin 2026',
    technologies: [
      'Next.js',
      'React',
    ...
    link: 'https://eco-renovation-toiture.com/',
    associated: 'IT Blaaan',
  },
  {
    id: 18,
    title: 'HC Piscines',
    description: 'Site web professionnel pour une entreprise spécialisée dans la rénovation, la réparation et la modernisation de piscines dans les Landes (40) et le Pays Basque (64).',
    domain: 'web-development',
    thumbnail: '/Siteweb/hc-piscines/couverture.jpg',
    images: [
      '/Siteweb/hc-piscines/couverture.jpg',
      '/Siteweb/hc-piscines/screenshot-2.jpg',
    ],
    logo: {
      url: '/Siteweb/hc-piscines/logo.svg',
      description: 'HC Piscines',
    },
    category: 'Web Development & Pool Renovation',
    ...
    link: 'https://www.hcpiscines.com/',
    associated: 'IT Blaaan',
  },
  {
    id: 19,
    title: 'IT Blaaan — Plateforme interne & vitrine digitale',
    description: 'Écosystème digital complet pour IT Blaaan : site vitrine, dashboard projets, facturation, RH et suivi des abonnements SaaS clients.',
    domain: 'web-development',
    thumbnail: '/Siteweb/it-blaaan/couverture.jpeg',
    images: [
      '/Siteweb/it-blaaan/couverture.jpeg',
      '/Siteweb/it-blaaan/screenshot-2.jpeg',
    ],
    logo: {
      url: '/logos/it-blaaan.png',
      description: 'IT Blaaan',
    },
    ...
    link: 'https://www.itblaaan.com/fr',
    associated: 'IT Blaaan',
  },
  {
    id: 20,
    title: 'Hôtel Le Rochegude',
    description: 'Site web moderne et intuitif pour un hôtel à Albi : présentation des chambres, réservation en ligne via Family Resa et optimisation SEO.',
    domain: 'web-development',
    thumbnail: '/Siteweb/hotel-le-rochegude/couverture.jpg',
    images: [
      '/Siteweb/hotel-le-rochegude/couverture.jpg',
      '/Siteweb/hotel-le-rochegude/screenshot-2.jpg',
    ],
    logo: {
      url: '/Siteweb/hotel-le-rochegude/logo.png',
      description: 'Hôtel Le Rochegude',
    },
    ...
    link: 'https://www.hotel-le-rochegude.com/',
    associated: 'IT Blaaan',
  },
  {
    id: 21,
    title: 'Smart Tourism Ifrane',
    description: 'Plateforme web de tourisme intelligent pour Ifrane : contenu dynamique multilingue (FR, EN, AR), CMS admin et services touristiques.',
    domain: 'web-development',
    thumbnail: '/Siteweb/smart-tourism-ifrane/couverture.jpg',
    images: [
      '/Siteweb/smart-tourism-ifrane/couverture.jpg',
      '/Siteweb/smart-tourism-ifrane/screenshot-2.jpg',
    ],
    logo: {
      url: '/Siteweb/smart-tourism-ifrane/logo.svg',
      description: 'Smart Tourism Ifrane',
    },
    category: 'Web Development & Smart Tourism',
    ...
    link: '#',
    associated: 'Projet PFE – Université Moulay Ismail Meknès',
  }
]
...
export function getProjectsByDomain(domain: ProjectDomain): Project[] {
  return sortProjectsByPeriodDesc(projects.filter((project) => project.domain === domain))
}

export function getSortedWebDevelopmentProjects(): Project[] {
  return sortProjectsByPeriodDesc(webDevelopmentProjects)
}
