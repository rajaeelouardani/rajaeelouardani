...
const getOrgLogoFallback = (company: string) => {
  const fallbackLogos: { [key: string]: string } = {
    ...
    'IT Blaaan': 'https://cdn.simpleicons.org/nextdotjs/000000',
  }
...
const getExperiences = (t: any) => [
  ...
  },
  {
    ...
    company: 'IT Blaaan',
    role: t.experience.experiences[15]?.role || 'Full Stack Engineer',
    description: t.experience.experiences[15]?.description || 'IT Blaaan — Plateforme interne & Site Web. Conception et développement d\'un écosystème digital complet pour IT Blaaan, cabinet de consulting IT & Digital basé à Meknès.',
    color: 'text-green-400',
  },
  {
