...
const getExperiences = (t: any) => [
  ...
  {
    period: 'Dec 2025',
    company: t.experience.experiences[12]?.company || 'ARMA Association',
    role: t.experience.experiences[12]?.role || 'Formatrice - Traitement d\'image',
    description: t.experience.experiences[12]?.description || 'Formation sur le traitement d\'image dans le cadre d\'une formation en IA/Robotique et traitement d\'image.',
    color: 'text-primary-500',
  },
]
