...
import { getSortedWebDevelopmentProjects } from '@/lib/projectsData'
...
function Portfolio() {
  ...
  const webProjectCoverImages = useMemo(() => {
    const images: string[] = []
    const sortedProjects = getSortedWebDevelopmentProjects()
    ...
    if (typeof window !== 'undefined') {
      ...
      console.log('Portfolio - Total projects:', sortedProjects.length)
