...
export const getCertOrgLogo = (issuer: string) => {
  const logoMap: { [key: string]: string } = {
    ...
    'University of Oxford': '/logos/university-of-oxford.png',
    'The World Bank Group': '/logos/world-bank-group.png',
    'Linux Professional Institute (LPI)': '/logos/lpi.png',
    'SCRUMstudy Mexico by SIXD': '/logos/scrumstudy.png',
    'Vabro.ai & VMEdu.com': '/logos/vmedu.png',
    ...
    'جامعة أكسفورد': '/logos/university-of-oxford.png',
    'مجموعة البنك الدولي': '/logos/world-bank-group.png',
    'أوراكل': '/logos/oracle.png',
  }
...
const certifications = [
  {
    id: 32,
    title: 'AI, Justice, and the Rule of Law',
    issuer: 'University of Oxford',
    date: 'Jul 2026',
    description: 'Certification sur l\'intelligence artificielle, la justice et l\'État de droit.',
    color: 'text-green-400',
  },
  {
    id: 33,
    title: 'Documenting Development Data Using Metadata Standards',
    issuer: 'The World Bank Group',
    date: 'Jul 2026',
    description: 'Formation sur la documentation des données de développement selon les standards de métadonnées. Compétences : gestion des données, Metadata Editor, métadonnées.',
    color: 'text-green-400',
  },
  {
    id: 34,
    ...
    date: 'May 2026',
    description: 'Certification Linux Essentials couvrant les fondamentaux de Linux, Bash et l\'administration système.',
    color: 'text-green-400',
    credentialId: 'lzy22gjm43',
  },
  {
    id: 35,
    title: 'Scrum Fundamentals Certified (SFC™)',
    issuer: 'SCRUMstudy Mexico by SIXD',
    date: 'Feb 2026',
    description: 'Formation certifiante sur les concepts clés de Scrum (SBOK® Guide) et les méthodologies Agile pour la livraison de projets réussis.',
    color: 'text-primary-500',
    credentialId: '1145156',
  },
  {
    id: 36,
    title: 'Marketing Strategy Fundamentals',
    issuer: 'Vabro.ai & VMEdu.com',
    date: 'Feb 2026',
    description: 'Certification en fondamentaux de stratégie marketing : analyse de marché, STP, proposition de valeur, Marketing Mix (4P/7P), différenciation et planification stratégique.',
    color: 'text-primary-500',
    credentialId: '1144967',
  },
  {
    id: 37,
    ...
    issuer: 'Vabro.ai & VMEdu.com',
    date: 'Feb 2026',
    description: 'Certification Six Sigma Yellow Belt en amélioration des processus et gestion de la qualité.',
    color: 'text-primary-500',
    credentialId: '1144963',
  },
  {
    id: 38,
    title: 'Oracle MySQL Explorer',
    issuer: 'Oracle',
    date: 'Jan 2026',
    description: 'Certification Oracle MySQL Explorer — exploration et gestion de bases de données MySQL.',
    color: 'text-primary-500',
  },
  {
    id: 0,
...
export const getCertificationsList = (t: any) => {
  const translationById = Object.fromEntries(
    (t?.certifications?.list || []).map((item: { id: number }) => [item.id, item])
  )

  const items = certifications.map((cert) => {
    const translation = translationById[cert.id]
    return {
      ...cert,
...
export default function Certifications() {
  ...
  const translatedCertifications = getCertificationsList(t)
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="ml-4 flex-shrink-0">
                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center border border-gray-300 p-2">
                      <Image
                        src={getCertOrgLogo((cert as any).issuerOriginal || cert.issuer)}
                        alt={cert.issuer}
                        width={32}
                        height={32}
                        className="w-full h-full object-contain"
                        unoptimized={getCertOrgLogo((cert as any).issuerOriginal || cert.issuer).endsWith('.jfif') || getCertOrgLogo((cert as any).issuerOriginal || cert.issuer).endsWith('.JFIF')}
                        onError={(e) => {
